...
_CFG = Config(
    ...
    max_rows=100, read_only=True, auth_enabled=False,
    server_name="trino-mcp", health_port=3001, jwks_url="", oidc_issuer="", oidc_audience="", transport="sse", mcp_port=3000, auth_required=False,
)
...
def test_build_server_applies_extra_registrars():
    ...
    mcp, _ = build_server(_CFG, extra_tool_registrars=[registrar], mcp_factory=lambda name: FakeMCP())
